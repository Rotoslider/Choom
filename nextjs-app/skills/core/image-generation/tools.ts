      ...
      properties: {
        ...
        references: {
          ...
          description:
            ...
            + 'ORDER MATTERS: the first reference lands leftmost in the frame. List people here, '
            + 'and describe them in the prompt, LEFT TO RIGHT as they should appear. Saying where each '
            + 'person sits ("Genesis on the left, Aloy in the middle, Eve on the right") is the '
            + 'reliable way to get the right face on the right person. '
