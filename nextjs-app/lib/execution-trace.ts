...
export class TraceBuilder {
  ...
  recordNudge(type: 'tool_use' | 'task_continuation' | 'unfinished_steps' | 'forced_tool_choice_ignored' | 'hedge_giveup' | 'gone_quiet' | 'cross_turn_repeat' | 'phantom_fabrication' | 'truncated_output' | 'reasoning_only'): void {
